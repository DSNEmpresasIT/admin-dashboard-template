                    ...
                    <div className="md:flex items-center">
                        <div className="xl:w-[30%] lg:w-1/3 md:w-1/2">
                            <div className="relative md:flex flex-col md:min-h-screen justify-center bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 md:px-10 py-10 px-4 z-1">
                                <div className="text-center">
                                    <Link href="/"><Image src='/images/logo-icon-64.png' width={72} height={64} placeholder="blur" blurDataURL="/dashboard/images/logo-icon-64.png"  className="mx-auto" alt=""/></Link>
                                </div>
                                <div className="title-heading text-center md:my-auto my-20">
                                <div className="text-center">
                                    <Image src='/images/client/05.jpg' width={96} height={96} sizes="100vw" placeholder="blur" blurDataURL="/dashboard/images/client/05.jpg" className="mx-auto h-24 w-24 rounded-full shadow dark:shadow-gray-700" alt=""/>
                        ...
                        <div className="xl:w-[70%] lg:w-2/3 md:w-1/2 flex justify-center mx-6 md:my-auto my-20">
                            <div>
                                ...
                                <div className="text-center">
                                    <div>
                                        <Image src='/images/contact.svg' width={0} height={0} sizes="100vw" placeholder="blur" blurDataURL="/dashboard/images/contact.svg" style={{width:"100%", height:'auto'}} className="max-w-xl mx-auto" alt=""/>
